...
static void	cleanup_interactive_textures(t_config *config)
{
...
static void	cleanup_lever_textures(t_config *config)
{
...
void	cleanup_config(t_config *config)
{
	if (!config)
		return ;
	cleanup_basic_textures(config);
	cleanup_interactive_textures(config);
	cleanup_lever_textures(config);
	if (config->map)
	{
